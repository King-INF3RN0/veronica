import openai
import logging
from helpers.history import load_important_info, save_important_info

# Configure logging
logging.basicConfig(level=logging.INFO)

async def analyze_message_with_model(message_text, model_name="gpt-3.5-turbo"):
    """Processes the message with the specified model to determine type and handle user data."""
    try:
...
async def handle_user_data(action_type, user_id, message_text):
    """Handles user data based on the determined action type."""
